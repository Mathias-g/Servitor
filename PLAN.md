...
- [ ] **`email_received` trigger.** Registered (a helper trigger for inbound email) but not served.
...
- [ ] **Bespoke per-provider signing schemes.** The receiver verifies the GitHub and Slack schemes (ADR-0025); Grist and Atomic remain open.
